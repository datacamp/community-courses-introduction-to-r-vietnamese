...
*** =sct
```{r}
msg = "&#272;&#7915;ng thay &#273;&#7893;i gi&aacute; tr&#7883; `survey_vector` and `factor_survey_vector`."
test_object("survey_vector", undefined_msg = msg, incorrect_msg = msg)
test_object("factor_survey_vector", eq_condition = "equal", undefined_msg = msg, incorrect_msg = msg)
msg <- "B&#7841;n &#273;&atilde; s&#7917; d&#7909;ng h&agrave;m `summary()` h&agrave;m ch&iacute;nh x&aacute;c ch&#432;a"
...
success_msg("R&#7845;t t&#7889;t! H&atilde;y xem k&#7871;t qu&#7843; cu&#7889;i c&ugrave;ng. Khi b&#7841;n g&aacute;n gi&aacute; tr&#7883; `"Male"` v&agrave; `"Female"` th&agrave;nh gi&aacute; tr&#7883; c&#7911;a factor trong `factor_survey_vector`, b&#7841;n cho ph&eacute;p R t&iacute;nh to&aacute;n v&agrave; hi&#7875;n th&#7883; s&#7889; l&#432;&#7907;ng c&aacute;c gi&aacute; tr&#7883; trong m&#7895;i bi&#7871;n.")
```
...
test_object("factor_speed_vector", eq_condition = "equal",
            incorrect_msg = "C&oacute; &#273;i&#7875;m g&igrave; &#273;&oacute; ch&#432;a ch&iacute;nh x&aacute;c v&#7899;i v&eacute;c-t&#417; `factor_speed_vector`; ki&#7875;m tra l&#7841;i `speed_vector`, `ordered = TRUE` and `levels = c("slow", "fast", "insane")` trong gi&aacute; tr&#7883; c&#7911;a h&agrave;m `factor()`.")
