...
Với kiến thức trên, bạn hãy dựa vào hướng dẫn dưới dây để hoàn thành bài tập.
...
- Chú ý là dấy `#` được dùng để thêm chú giải trong R.
...
*** =hint
Trong phần thực hành, chúng ta đã gán giá trị 4 cho `my_variable`. Bắt chước giống hệt vậy trong editor, chỉ thay đổi ở việc gán giá trị 42 cho biến `x`.
